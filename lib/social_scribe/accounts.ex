defmodule SocialScribe.Accounts do
  ...
  def find_or_create_hubspot_credential(user, attrs) do
    find_or_create_provider_credential(user, "hubspot", attrs)
  end
  ...
  def find_or_create_salesforce_credential(user, attrs) do
    find_or_create_provider_credential(user, "salesforce", attrs)
  end

  @doc """
  Finds or creates a credential for a given provider using provider uid.
  """
  def find_or_create_provider_credential(user, provider, attrs) do
    case get_user_credential(user, provider, attrs.uid) do
      nil ->
